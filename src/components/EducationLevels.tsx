...
import { Baby, BookOpen, GraduationCap, Rocket } from "lucide-react";
  ...
  const levels = [
    {
      ...
      icon: Baby,
      title: "1º ao 5º ano",
      description: "Base sólida com acolhimento e valores",
      features: [
        "Alfabetização com metodologia diferenciada",
        "Aulas socioemocionais semanais",
        "Projetos criativos e culturais",
        "Atividades esportivas e artísticas",
        "Desenvolvimento de valores fundamentais",
      ],
    },
    {
      id: "fundamental2",
    ...
    <section id="ensino" className="py-20 lg:py-32 bg-gradient-warm">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Do 1º ano ao Pré-vestibular, acompanhamento completo da jornada educacional
          </p>
        </div>

        <Tabs defaultValue="fundamental1" className="max-w-5xl mx-auto">
